...
const generateToken = (id) => {
  return jwt.sign({ id }, process.env.JWT_SECRET || 'rasyaan_pahadi_secret_key_2026_super_secure_jwt', {
...
export const registerUser = async (req, res) => {
  try {
    ...
    const initialAddresses = address ? [address] : [];
